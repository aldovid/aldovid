...
<%     
    ...
    String html="";
    ResultSet rs2,rs3;
    rs2 = fuente.obtenerDato("select * from mae_yemsys_modulos where id_estado=1 ");// 1 ES IGUAL A ACTIVO.
    ...
    while(rs2.next())
    {
        ...
        rs3 = fuente.obtenerDato("  select * from  mae_yemsys_det_modulos where    id_modulos="+rs2.getString("id")+" ");
