...
<div class="float-right d-none d-sm-inline-block" href="#" data-toggle="modal" data-target=".bd-example-modal-xx"
     onclick="cargar_datos_modal_version('0029-REP-01032022-A','VERSION: 0029-REP-01032022-A')">
    <label neme="label_contenido" id="label_contenido">0029-PAN-01032022-A</label>  
</div>
