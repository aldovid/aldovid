...
function boton_atras() 
{
    ...
    { 
        switch (window.location.hash) 
        {
            ...
            case "#ptcRegistroRetenido":
                ...
                li_active_menu("sub_inf_ptc_reg_ret");
            break;
            ...
            case "#ptcPendientesRecogida":
                ...
                li_active_menu("sub_inf_ptc_reg_pendienteReco");
            break;
            
             case "#ptcTransformacionPallet":
                 ir_transformacion_pallet_carro();
                li_active_menu("sub_inf_ptc_reg_palletAcarro");
            break;
            ...
            case "#ptcConfiguracionEmp":
                ...
                li_active_menu("sub_inf_ptc_empacadora_upd");
            break;
            ...
            case "#misTransfeReprocesos":
                ...
                li_active_menu("sub_transf_mis_rep");
            break;
            
            case "#misPendientesAlimen":
                 ir_informe_pendientes_alimentacion_mis();
                li_active_menu("sub_rep_pendiente_alimentar");
            break;
            ...
            break;
             ...
             case "#pprRegistroUsuario":
                 traer_vista_usuario_ppr();
                li_active_menu("sub_registrar_usuario");
            break;
            ...
            case "#pprPermisosRoles":
                 ir_permisos_roles();
                li_active_menu("sub_seguridad_registro_permisos");
            break;
   ...
   function ir_permisos_roles()
    {
        window.location.hash = "pprPermisosRoles";
        $.ajax({
        type: "POST",
